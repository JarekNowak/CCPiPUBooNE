...
// ​
const double FVxmin = 12.0;            //12
const double FVxmax = 256.35 - 12.0;  //244.35
const double FVymin = -115.53 + 35;  //-80.53
const double FVymax = 117.47 - 35;   //82
const double FVzmin = 0.1 + 25;      //25.1
const double FVzmax = 1036.9 - 85;   //951.9
// ​
